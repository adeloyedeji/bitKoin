			...
			<section class="section section--no-pt section--no-pb section--light-bg">
				<div class="grid grid--container">
					<div class="authorization authorization--login">
                        ...
                        <form class="authorization__form"  method="POST" action="{{ route('password.update') }}">
                            @csrf
							...
							<div class="input-wrp">
                                <input class="textfield{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" value="{{ $email ?? old('email') }}" placeholder="Email" name="email" id="email" required autofocus>
                                @if ($errors->has('email'))
